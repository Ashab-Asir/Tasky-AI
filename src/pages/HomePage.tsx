...
const HomePage = () => {
  return (
    <>
      <Head title="Tasky AI"></Head>
      <section>
        <div className="container !px8 grid grid-cols-1 gap-8 items-center xl:gap-12 xl:grid-cols-[1fr_1.5fr] ">
          <div className="flex flex-col items-center text-center space-y-4 lg:text-left lg:items-start  lg:space-y-6">
            <h1 className="text-4xl font-semibold max-w-[22ch] md:text-5xl lg:text-6xl xl:text-5xl 2xl:text-6xl ">
              Simpliy Your Work and Life with{" "}
          ...
          <figure className="bg-secondary rounded-2xl overflow-hidden aspect-square max-md:max-w-[480px] md:aspect-video">
            <img
              src={heroBannerSm}
              alt="Tasky AI"
              width={480}
